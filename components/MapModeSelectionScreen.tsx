...
interface MapModeSelectionScreenProps {
...
const MapModeSelectionScreen: React.FC<MapModeSelectionScreenProps> = ({ onStartGame, onBack }) => {
...
export default MapModeSelectionScreen;