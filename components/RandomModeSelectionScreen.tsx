...
interface RandomModeSelectionScreenProps {
...
const RandomModeSelectionScreen: React.FC<RandomModeSelectionScreenProps> = ({ onStartGame, onBack }) => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto p-4 md:p-8 animate-fadeIn">
        ...
        <div className="space-y-10">
            <section>
                <h2 className="text-2xl font-bold text-slate-700 dark:text-gray-300 mb-4 text-center">Select a Difficulty</h2>
                <p className="text-lg text-slate-600 dark:text-gray-400 mb-8 text-center">Everything else will be randomized for you!</p>
...
export default RandomModeSelectionScreen;